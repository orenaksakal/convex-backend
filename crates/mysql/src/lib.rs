...
impl<RT: Runtime> Persistence for MySqlPersistence<RT> {
            ...
            .transact(async move |tx| {
                ...
                for chunk in &mut index_chunks {
                    ...
                    let future = async {
                        ...
                        indexes::single_table::write_index_chunk(
                            tx,
                            chunk,
                            conflict_strategy,
                            multitenant,
    ...
    async fn load_index_chunk(
        ...
        indexes::single_table::load_index_chunk(self, cursor, chunk_size).await
    }
    ...
    async fn delete_index_entries(
        ...
        indexes::single_table::delete_index_entries(self, expired_entries).await
    }
